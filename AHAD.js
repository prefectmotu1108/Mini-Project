    ...
    <>
      <Container>
        <InnerContainer>
          ...
          <RowOne>
            <h1>Aashiyana Hostel & Dormitory</h1>
            <h3>Nagpur</h3>
          </RowOne>
          {/* Place IMAGE */}
          <RowTwo>
            <img
              src="https://lh3.googleusercontent.com/p/AF1QipNQ-c0d1p5oGasgKhaAZayiSsibBXekhgSOAFda=w296-h202-n-k-rw-no-v1"
              alt=""
            />{" "}
          </RowTwo>
          <p>
            Plot No 4 First Floor, Celebration Hall, Great Nag Rd, above JD
            Fitness, opp. NIT complex, Sakkardara, Ayurvedic Layout, Ayurvedic
            Layout, Azamshah Layout, Nagpur, Maharashtra 440009
          </p>
          <RowThree>
          ...
          <h2>Distance from:</h2>
          <p>Nagpur Airport- 10 km </p>
          <p> Nagpur Railway Station- 5.5 km</p>
          <RowSeven>
            <h2>Place to visit nearby</h2>
            <p>Sitabuldi Fort-8.1 km</p>
            <p>Ambazari Lake-9 km </p>
            <p>Futala Lake- 11.3 km</p>
            <p>Japanese Rose Garden- 10 km</p>
          </RowSeven>
          {/* WRITE REVIEW */}
          <RowEight>
