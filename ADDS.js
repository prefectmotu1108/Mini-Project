    ...
    <>
      <Container>
        <InnerContainer>
          ...
          <RowOne>
            <h1>Anand Darbar Dattanagar Sthanak</h1>
            <h3>Pune</h3>
          </RowOne>
          {/* Place IMAGE */}
          <RowTwo>
            <img
              src="https://lh5.googleusercontent.com/p/AF1QipOot0pRo2l_QY5HtRNhgXQVz-x_d_3c8nrxDH9L=w141-h118-n-k-no-nu"
              alt=""
            />{" "}
          </RowTwo>
          <p>
            71, Narhe Ambegaon Road, Santosh Nagar, Ambegaon BK, Pune,
            Maharashtra 411046
          </p>
          <RowThree>
          ...
          <h2>Distance from:</h2>
          <p>Pune Airport- 19.5km </p>
          <p> Pune Railway Station- 11.9km</p>
          <RowSeven>
            <h2>Place to visit nearby</h2>
            <p>Dagdu Seth Halwai Ganpati Temple-8.5 km</p>
            <p>Singhard Fort-27.9 km </p>
            <p>Pataleshwar Temple- 10.7 km</p>
            <p>Shaniwar Wada- 9.5 km</p>
          </RowSeven>
          {/* WRITE REVIEW */}
          <RowEight>
