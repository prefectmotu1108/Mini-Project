    ...
    <>
      <Container>
        <InnerContainer>
          ...
          <RowOne>
            <h1>Shriram Dharamshala</h1>
            <h3>Nagpur</h3>
          </RowOne>
          {/* Place IMAGE */}
          <RowTwo>
            <img
              src="https://content.jdmagicbox.com/comp/nagpur/f3/0712px712.x712.171101225403.r3f3/catalogue/shrimati-malti-gupta-dharamshala-central-avenue-nagpur-dharamshalas-a07ujf2ft5-250.jpg"
              alt=""
            />{" "}
          </RowTwo>
          <p>
            43JW+MRV, Medical Chowk, Rambagh Layout, Untkhana, Nagpur,
            Maharashtra 440003
          </p>
          <RowThree>
          ...
          <h2>Distance from:</h2>
          <p>Nagpur Airport- 9m </p>
          <p> Nagpur Railway Station- 2.9 km</p>
          <RowSeven>
            <h2>Place to visit nearby</h2>
            <p>Sitabuldi Fort-4.6 km</p>
            <p>Ambazari Lake-7.3 km </p>
            <p>Futala Lake- 7.8 km</p>
            <p>Japanese Rose Garden- 6.5 km</p>
          </RowSeven>
          {/* WRITE REVIEW */}
          <RowEight>
