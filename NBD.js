    ...
    <>
      <Container>
        <InnerContainer>
          ...
          <RowOne>
            <h1>Nakoda Bhairav Dharamshala</h1>
            <h3>Pune</h3>
          </RowOne>
          {/* Place IMAGE */}
          <RowTwo>
            <img
              src="https://4.bp.blogspot.com/-SyBvGEqon6M/U9IiKypUehI/AAAAAAAAfgM/090rDYkKoDI/s1600/IMG-20140725-WA0008-735014.jpg"
              alt=""
            />{" "}
          </RowTwo>
          <p>
            210, Lallubhai Damodardas Rd, shitla devi chowk, chowk, Guruwar
            Peth, Pune, Maharashtra 411042
          </p>
          <RowThree>
          ...
          <h2>Distance from:</h2>
          <p>Pune Airport- 11.3 km </p>
          <p> Pune Railway Station- 4.1km</p>
          <RowSeven>
            <h2>Place to visit nearby</h2>
            <p>Dagdu Seth Halwai Ganpati Temple-22 km</p>
            <p>Singhard Fort-36.3 km </p>
            <p>Pataleshwar Temple- 2.7 km</p>
            <p>Shaniwar Wada- 2.2 km</p>
          </RowSeven>
          {/* WRITE REVIEW */}
          <RowEight>
